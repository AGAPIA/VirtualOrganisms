...
struct Cell
{
	...
	*/
	...
	bool onRootMsgReorganize(); // Called to reorganize the tree for better performance | Root only !
								// Returns false if there is another reorganization in progress - for simulator/simulation purpose
								//----------------------------------------------
